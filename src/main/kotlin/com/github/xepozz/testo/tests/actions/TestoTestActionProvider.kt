...
class TestoTestActionProvider : ToggleModelActionProvider {
    override fun createToggleModelAction(properties: TestConsoleProperties?): ToggleModelAction? {
        // TODO: Implement this method
        return TestoToggleModelAction(properties)
    }
}

class TestoToggleModelAction(properties: TestConsoleProperties?) : ToggleModelAction(
    "Testo Button",
    "It does something",
    TestoIcons.TESTO,
    properties,
